...
# helm install domain01 domain --repo oci://$YYREPO/$YYREPODOM/helm/domain --version 1 --set image.repository=$YYREPOIMG,weblogic.managedServersCount=2,image.repo=$YYREPO,image.pullUsername=$YYREPODOM/$YYUSU,image.pullPassword=$YYTOKENCLA 
